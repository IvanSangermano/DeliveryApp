...
export const AdminProductCreateScreen = ({ navigation, route}: Props) => {
    ...
    const {name, description, price, image1, image2, image3, errorMessage, successMessage, loading, onChange, pickImage, takePhoto, createProduct } = useViewModel(category)
        ...
        <View style={styles.container}>
            ...
            <View style={styles.form}>
                ...
                <View style={{marginTop: 20}}>
                    <RoundedButton text='CREAR PRODUCTO' onPress={() =>{createProduct()}} />
                </View>
